...
public class profileEdit extends AppCompatActivity implements LoaderManager.LoaderCallbacks <Cursor> {
    ...
    private String mType = ProfileContract.ContactEntry.TYPEOFCONTACT_PERSONAL;
    ImageView mPhoto;
    ...
    private boolean saveContact() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            values.put(ProfileContract.ContactEntry.COLUMN_EMAIL, email);
        }
        ...
        if (mCurrentContactUri == null) {
            ...
            Uri newUri = getContentResolver().insert(ProfileContract.ContactEntry.CONTENT_URI, values);
            if (newUri == null) {
    ...
    public void onLoadFinished( Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (typeof) {
                ...
                case ProfileContract.ContactEntry.TYPEOFCONTACT_HOME:
                    mSpinner.setSelection(1);
                    break;

                case ProfileContract.ContactEntry.TYPEOFCONTACT_WORK:
